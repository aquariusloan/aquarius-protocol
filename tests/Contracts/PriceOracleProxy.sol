...
contract PriceOracleProxy is PriceOracle {
    ...
    /// @notice Address of the cUSDT contract, which uses the aUSDC price
     ...
     * @param cUsdtAddress_ The address of cUSDT, which uses the aUSDC price
     */
    ...
    function getUnderlyingPrice(AToken aToken) public view returns (uint) {
        ...
        address underlying = AErc20(aTokenAddress).underlying();
