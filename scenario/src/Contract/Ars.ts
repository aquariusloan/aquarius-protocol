...
export interface ArsScenarioMethods extends ArsMethods {
...
export interface Ars extends Contract {
  methods: ArsMethods;
  name: string;
}

export interface ArsScenario extends Contract {
  methods: ArsScenarioMethods;
  name: string;
}
