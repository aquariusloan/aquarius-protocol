...
(async function() {
  ...
  let contract = await saddle.deploy('AErc20Delegator', deployArgs);
  ...
  if (env['VERIFY']) {
    ...
    await saddle.verify(etherscanApiKey, contract._address, 'AErc20Delegator', deployArgs, 0);
