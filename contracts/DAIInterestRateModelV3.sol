...
/**
  * @title Aquarius's DAIInterestRateModel Contract (version 3)
  * @author Aquarius (modified by Dharma Labs)
...
contract DAIInterestRateModelV3 is JumpRateModelV2 {
     ...
     */
    constructor(uint jumpMultiplierPerYear,
                uint kink_,
                address pot_,
                address jug_,
                address owner_,
                address operatorGuardian_) JumpRateModelV2(0, 0, jumpMultiplierPerYear, kink_, owner_, operatorGuardian_) public {
