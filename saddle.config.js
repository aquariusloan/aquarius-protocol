  ...
  networks: {                                               // Define configuration for each network
    ...
    goerli: {
      providers: [
        ...
        {http: "https://goerli-eth.aquarius.loan"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
    ...
    ropsten: {
      providers: [
        ...
        {http: "https://ropsten-eth.aquarius.loan"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
    ...
    rinkeby: {
      providers: [
        ...
        {http: "https://rinkeby-eth.aquarius.loan"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
    ...
    kovan: {
      providers: [
        ...
        {http: "https://kovan-eth.aquarius.loan"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
    ...
    mainnet: {
      providers: [
        ...
        {http: "https://mainnet-eth.aquarius.loan"}
      ],
      web3: {
        gas: [
          {env: "GAS"},
